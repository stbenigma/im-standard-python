...
,CONSTRAINT DOMA_ExDep1
 ...
 ,CONSTRAINT DOMA_STFO_FK FOREIGN KEY (     DOMA_BIN_STFO_ID) REFERENCES STORAGE_FORMATS (     STFO_ID )
 ON DELETE NO ACTION
 ON UPDATE NO ACTION
);
...
CREATE TABLE MODE_DOCU
    ...
    ,CONSTRAINT MODO_DOCU_FK FOREIGN KEY    (     MODO_DOCU_ID)    
			REFERENCES DOCUMENTS    (     DOCU_ID )    ON DELETE CASCADE
