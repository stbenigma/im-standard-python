	...
	select sptx_text,spra_id,spra_iso_code2,sptx_mode_id,sptx_attrname
	 ...
	 REFERENCES modellelem_typ(melt_id)
	  ...
	  CREATE TABLE ATTR_TRANSF 
	      (
	       ATTF_ID NUMERIC (10) NOT NULL IDENTITY (1 , 1) NOT FOR REPLICATION , 
	       ...
	       ATTF_AUSLOESEPERIOD NUMERIC (5) NULL , 
	       ATTF_SCHA_ID NUMERIC (10) NULL , 
	       ATTF_ATTR_ID NUMERIC (10) NULL , 
	       ATTF_UC AS  , 
	       ATTF_DC DATETIME NOT NULL , 
	       ATTF_UM VARCHAR (30) NULL , 
	       ATTF_DM DATETIME NULL , 
	       CONSTRAINT ATTF_CHK CHECK ((ATTF_SCHA_ID IS NULL AND ATTF_ATTR_ID IS NOT NULL AND ATTR_RICHTUNG = 'INBOUND')
	  OR (ATTF_SCHA_ID IS NOT NULL AND ATTF_ATTR_ID IS NULL AND ATTR_RICHTUNG = 'OUTBOUND'))
	      )
	  GO 
	  ALTER TABLE ATTR_TRANSF 
	      ADD CONSTRAINT FKArc_6 CHECK ( 
	          (  (ATTF_SCHA_ID IS NOT NULL) AND 
	           (ATTF_ATTR_ID IS NULL) ) OR 
	          (  (ATTF_ATTR_ID IS NOT NULL) AND 
	           (ATTF_SCHA_ID IS NULL) )  ) 
	  ;
	  ALTER TABLE ATTR_TRANSF ADD CONSTRAINT ATTF_PK PRIMARY KEY CLUSTERED (ATTF_ID ASC)
     
	  GO
	  ALTER TABLE ATTR_TRANSF ADD CONSTRAINT ATTR_UN UNIQUE NONCLUSTERED (ATTF_RICHTUNG ASC, ATTF_SCHA_ID ASC, ATTF_ATTR_ID ASC)
	  GO
	  CREATE TABLE SCHNITTSTELLE 
	      (
	       SCHN_ID NUMERIC (10) NOT NULL , 
	       SCHN_NAME VARCHAR (60) NOT NULL , 
	       SCHN_UC AS USER , 
	       SCHN_DC DATETIME NOT NULL , 
	       SCHN_UM VARCHAR (30) NULL , 
	       SCHN_DM DATETIME NULL 
	      )
	  GO

	  ALTER TABLE SCHNITTSTELLE ADD CONSTRAINT SCHNITTSTELLE_PK PRIMARY KEY CLUSTERED (SCHN_ID ASC)
     
	  GO
	  ALTER TABLE SCHNITTSTELLE ADD CONSTRAINT SCHN_UN UNIQUE NONCLUSTERED (SCHN_NAME ASC)
	  GO

	  CREATE TABLE SCHNITTSTELLE_ATTR 
	      (
	       SCHA_ID NUMERIC (10) NOT NULL IDENTITY (1 , 1) NOT FOR REPLICATION , 
	       ...
	       SCHA_TABL_ID NUMERIC (10) NOT NULL , 
	       SCHA_DATY_ID NUMERIC (10) NOT NULL , 
	       SCHA_UC AS  , 
	       SCHA_DC DATETIME NOT NULL , 
	       SCHA_UM VARCHAR (30) NULL , 
	       SCHA_DM DATETIME NULL 
	      )
	  GO 

	  ALTER TABLE SCHNITTSTELLE_ATTR ADD CONSTRAINT SCHA_PK PRIMARY KEY CLUSTERED (SCHA_ID ASC)
     
	  GO
	  ALTER TABLE SCHNITTSTELLE_ATTR ADD CONSTRAINT SCHA_UN UNIQUE NONCLUSTERED (SCHA_COLUMN_NAME ASC)
	  GO
	  ...
	  CREATE TABLE TABELLE 
	      (
	       ...
	       TABL_SCHN_ID NUMERIC (10) NOT NULL , 
	       TABL_PREFIX VARCHAR (60) NULL , 
	       TABL_BESCHR VARCHAR (4000) NULL , 
	       TABL_UC AS USER , 
	       TABL_DC DATETIME NOT NULL , 
	       TABL_UM VARCHAR (30) NULL , 
	       TABL_DM DATETIME NULL 
	      )
	  GO

	  ALTER TABLE TABELLE ADD CONSTRAINT TABL_PK PRIMARY KEY CLUSTERED (TABL_ID ASC)
     
	  GO
	  ALTER TABLE TABELLE ADD CONSTRAINT TABL_UN UNIQUE NONCLUSTERED (TABL_SCHN_ID ASC, TABL_NAME ASC)
	  GO
	  ...
	  CREATE TABLE TABL_ENTI_MAP 
	      (
	       ...
	       TEMA_BEZI_ID NUMERIC (10) NULL , 
	       CONSTRAINT TABL_ENTI_MAP_CK_1 CHECK ((TABL_ENTI_ID IS NOT NULL AND TABL_BEZI_ID IS NULL )
	  OR (TABL_BEZI_ID IS NULL AND TABL_BEZI_ID IS NOT NULL))
	      )
	  GO 
	  ALTER TABLE TABL_ENTI_MAP 
	      ADD CONSTRAINT FKArc_5 CHECK ( 
	          (  (TEMA_BEZI_ID IS NOT NULL) AND 
	           (TEMA_ENTI_ID IS NULL) ) OR 
	          (  (TEMA_ENTI_ID IS NOT NULL) AND 
	           (TEMA_BEZI_ID IS NULL) ) OR  
	          (  (TEMA_BEZI_ID IS NULL)  AND 
	  ...
	  CREATE TABLE TRANSF_USAGE 
	      (
	       TFUS_ID NUMERIC (10) NOT NULL , 
	       TFUS_ATTF_ID NUMERIC (10) NOT NULL , 
	       TFUS_ATTR_ID NUMERIC (10) NULL , 
	       TFUS_SCHA_ID NUMERIC (10) NULL , 
	       TFUS_UC AS  , 
	       TFUS_DC DATETIME NOT NULL , 
	       TFUS_UM VARCHAR (30) NULL , 
	       TFUS_DM DATETIME NULL 
	      )
	  GO 
	  ALTER TABLE TRANSF_USAGE 
	      ADD CONSTRAINT FKArc_7 CHECK ( 
	          (  (TFUS_SCHA_ID IS NOT NULL) AND 
	           (TFUS_ATTR_ID IS NULL) ) OR 
	          (  (TFUS_ATTR_ID IS NOT NULL) AND 
	           (TFUS_SCHA_ID IS NULL) )  ) 
	  ;

	  ALTER TABLE TRANSF_USAGE ADD CONSTRAINT TFUS_PKv2 PRIMARY KEY CLUSTERED (TFUS_ID ASC)
     
	  GO
	  ALTER TABLE TRANSF_USAGE ADD CONSTRAINT TFUS__UN UNIQUE NONCLUSTERED (TFUS_ATTF_ID ASC, TFUS_ATTR_ID ASC, TFUS_SCHA_ID ASC)
	  GO

	  ALTER TABLE ATTR_TRANSF 
	      ADD CONSTRAINT ATTF_ATTR_FK FOREIGN KEY 
	      ( 
	       ATTF_ATTR_ID
	      ) 
	  ...
	  ALTER TABLE ATTR_TRANSF 
	      ADD CONSTRAINT ATTF_SCHA_FK FOREIGN KEY 
	      ( 
	       ATTF_SCHA_ID
	      ) 
	      REFERENCES SCHNITTSTELLE_ATTR 
	      ( 
	       SCHA_ID 
	      ) 
	      ON DELETE CASCADE 
	  ...
	  ALTER TABLE MODELLELEMENT 
	      ADD CONSTRAINT MODE_ATTR_FK_IST FOREIGN KEY 
	      ( 
	       MODE_ATTR_ID
	      ) 
	      REFERENCES ATTRIBUTES 
	  ...
	  ALTER TABLE MODELLELEMENT 
	      ADD CONSTRAINT MODE_BURU_FK_IST FOREIGN KEY 
	      ( 
	       MODE_BURU_ID
	      ) 
	  ...
	  ALTER TABLE MODELLELEMENT 
	      ADD CONSTRAINT MODE_ENTI_FK_IST FOREIGN KEY 
	      ( 
	       MODE_ENTI_ID
	      ) 
	      REFERENCES ENTITAET 
	  ...
	  ALTER TABLE MODELLELEMENT 
	      ADD CONSTRAINT MODE_SCHA_FK FOREIGN KEY 
	      ( 
	       MODE_SCHA_ID
	      ) 
	      REFERENCES SCHNITTSTELLE_ATTR 
	  ...
	  ALTER TABLE MODELLELEMENT 
	      ADD CONSTRAINT MODE_SYNO_FK FOREIGN KEY 
	      ( 
	       MODE_SYNO_ID
	      ) 
	      REFERENCES SYNONYM 
	  ...
	  ALTER TABLE MODELLELEMENT 
	      ADD CONSTRAINT MODE_TABL_FK FOREIGN KEY 
	      ( 
	       MODE_TABL_ID
	      ) 
	      REFERENCES TABELLE 
	  ...
	  ALTER TABLE SCHLUESSELELEMENT 
	      ADD CONSTRAINT SCEL_ATTR_FK FOREIGN KEY 
	      ( 
	       SCEL_ATTR_ID
	      ) 
	      REFERENCES ATTRIBUTES 
	  ...
	  ALTER TABLE SCHLUESSELELEMENT 
	      ADD CONSTRAINT SCEL_SCHL_FK FOREIGN KEY 
	      ( 
	       SCEL_SCHL_ID
	      ) 
	      REFERENCES SCHLUESSEL 
	      ( 
	       SCHL_ID 
	      ) 
	      ON DELETE CASCADE 
	  ...
	  ALTER TABLE SCHNITTSTELLE_ATTR 
	      ADD CONSTRAINT SCHA_DATY_FK FOREIGN KEY 
	      ( 
	       SCHA_DATY_ID
	      ) 
	  ...
	  ALTER TABLE SCHNITTSTELLE_ATTR 
	      ADD CONSTRAINT SCHA_TABL_FK FOREIGN KEY 
	      ( 
	       SCHA_TABL_ID
	      ) 
	      REFERENCES TABELLE 
	  ...
	  ALTER TABLE TABELLE 
	      ADD CONSTRAINT TABL_SCHN_FK FOREIGN KEY 
	      ( 
	       TABL_SCHN_ID
	      ) 
	  ...
	  ALTER TABLE TABL_ENTI_MAP 
	      ADD CONSTRAINT TEMA_BEZI_FK FOREIGN KEY 
	      ( 
	       TEMA_BEZI_ID
	      ) 
	  ...
	  ALTER TABLE TRANSF_USAGE 
	      ADD CONSTRAINT TFUS_ATTF_FK FOREIGN KEY 
	      ( 
	       TFUS_ATTF_ID
	      ) 
	      REFERENCES ATTR_TRANSF 
	      ( 
	       ATTF_ID 
	      ) 
	      ON DELETE NO ACTION 
	  ...
	  ALTER TABLE TRANSF_USAGE 
	      ADD CONSTRAINT TFUS_ATTR_FK FOREIGN KEY 
	      ( 
	       TFUS_ATTR_ID
	      ) 
	      REFERENCES ATTRIBUTES 
	  ...
	  ALTER TABLE TRANSF_USAGE 
	      ADD CONSTRAINT TFUS_SCHA_FK FOREIGN KEY 
	      ( 
	       TFUS_SCHA_ID
	      ) 
	      REFERENCES SCHNITTSTELLE_ATTR 
