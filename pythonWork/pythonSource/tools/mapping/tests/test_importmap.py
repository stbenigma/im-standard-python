...
from tools.mapping import listmapping, importMAP, mappingexceldata as mapxls
...
class ListImportMapping(unittest.TestCase):
    ...
    def test_importmain(self):
        ...
        with tempfile.TemporaryDirectory() as tempdir:
            ...
            testexcel = Path(tempdir + "/testexcel.xlsx")
            ...
            listmapping.writeintfxls(pfilename=testexcel, pmodel=locmodel,
            ...
            ws = wb["TestMapping"]
            ws.cell(6, 12).value = ws.cell(6, 12).value + "\nLand"
            ...
            enti = checkmodel.getbyfield(ptype="entities", pvalue="Personenrolle", plang="de")
            attr = [a for a in enti[0][1]["attributes+"] if checkmodel.getbyid(a)["name"]['de'] == "Dauer"]
