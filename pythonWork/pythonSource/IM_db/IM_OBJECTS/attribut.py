...
CREATE TABLE attributes(
	...
	CONSTRAINT attr_arc_fk CHECK((attr_enti_id is null and attr_rela_id is not null) 
								or (attr_enti_id is not null and attr_rela_id is null)),
	...
	CONSTRAINT attr_bezi_fk FOREIGN KEY(attr_rela_id)
