...
CREATE TABLE TABL_ENTI_MAP 
    (
     ...
     CONSTRAINT FKArc_5 CHECK ([TEMA_RELA_ID] IS NOT NULL AND [TEMA_ENTI_ID] IS NULL OR [TEMA_ENTI_ID] IS NOT NULL AND [TEMA_RELA_ID] IS NULL )
    )
GO
...
GO
ALTER TABLE TABL_ENTI_MAP ADD CONSTRAINT TEMA_UN UNIQUE NONCLUSTERED (TEMA_TABL_ID ASC, TEMA_ENTI_ID ASC, TEMA_RELA_ID ASC)
GO
