...
GO
ALTER TABLE COLUMNS ADD CONSTRAINT COLU_UK UNIQUE NONCLUSTERED (COLU_TABL_ID ASC, COLU_COLUMN_NAME ASC)
GO
...
GO
ALTER TABLE entity_categories ADD CONSTRAINT ENCA_UK UNIQUE NONCLUSTERED (ENCA_NAME ASC)
GO

ALTER TABLE entity_categories ADD CONSTRAINT ENCA_PK PRIMARY KEY CLUSTERED (ENCA_ID ASC)
GO
...
CREATE TABLE USER_DEFINED_PROPERTIES 
    (
     ...
     UDPR_DEFAULTVALUE VARCHAR (4000) NULL ,
...
CREATE TABLE ELEMENT_UI
    (
     ...
     ELUI_OPACITY NUMERIC (3) NULL DEFAULT (100) CONSTRAINT CK__ELEMENTRE__ELER___3CF40B7E CHECK ( [ELER_OPACITY]>=(0) AND [ELER_OPACITY]<=(100) ) ,
     ELUI_COLOR VARCHAR (6) NULL DEFAULT '000000' CONSTRAINT CK__ELEMENTRE__ELER___3EDC53F0 CHECK ( datalength(ELUI_COLOR) = 6 ) ,
     ELUI_MARGINWIDTH NUMERIC (3,1) NULL DEFAULT (1) ,
     ELUI_MARGINOPACITY NUMERIC (3) NULL DEFAULT (100) CONSTRAINT CK__ELEMENTRE__ELER___41B8C09B CHECK ( [ELER_MARGINOPACITY]>=(0) AND [ELER_MARGINOPACITY]<=(100) ) ,
     ELUI_MARGINCOLOR VARCHAR (6) NULL DEFAULT '000000' CONSTRAINT CK__ELEMENTRE__ELER___43A1090D CHECK ( datalength(ELUI_MARGINCOLOR) = 6 ) ,
     ELUI_FONTSIZE NUMERIC (3) NULL CONSTRAINT CK__ELEMENTRE__ELER___44952D46 CHECK ( [ELER_FONTSIZE]>=(1) AND [ELER_FONTSIZE]<=(999) ) ,
     ELUI_FONTCOLOR VARCHAR (6) NULL DEFAULT '000000' CONSTRAINT CK__ELEMENTRE__ELER___467D75B8 CHECK ( datalength(ELUI_FONTCOLOR) = 6 )
    )
GO
...
ALTER TABLE ELEMENT_UI ADD CONSTRAINT ELUI_PK PRIMARY KEY CLUSTERED (ELUI_ID ASC)
GO
ALTER TABLE ELEMENT_UI ADD CONSTRAINT ELUI_UK_ROLE UNIQUE NONCLUSTERED (ELUI_MELT_ID ASC, ELUI_ENCA_ID ASC)
GO
