...
class MyTestCase(unittest.TestCase):
    ...
    def test_functions(self):
        ...
        self.assertEqual(tablename,tabs[0])

        cols=ddlconn.getcolums(tablename=tablename)
        ...
        uks=ddlconn.getuklist(tablename=tablename)
        ...
        fks=ddlconn.getfklist(tablename=tablename)
